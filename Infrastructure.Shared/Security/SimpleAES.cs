...
namespace Infrastructure.Shared.Security
{
    ...
    {
        // Change these keys 
        public byte[] Key = { 123, 217, 19, 11, 24, 26, 85, 45, 114, 184, 27, 162, 37, 112, 222, 209, 241, 24, 175, 144, 173, 53, 196, 29, 24, 26, 17, 218, 131, 236, 53, 209 };
        ...
        public string Decrypt(byte[] EncryptedValue)
        {
            ...
            #endregion
            return UTFEncoder.GetString(decryptedBytes, 0, decryptedBytes.Length);
        }
